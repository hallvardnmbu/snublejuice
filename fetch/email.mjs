    ...
    users.map((user) => ({
      ...
      <html>
          ...
          <body>
              <div>
                  <p>
                      <strong>Nå er det endelig ny måned med nye tilbud!</strong>
                  </p>
                  ...
                  <menu class="landing-menu">
                      <li>
                          <a href="https://vinmonopolet.snublejuice.no">vinmonopolet.snublejuice.no</a>
                      </li>
                      <li>
                          <img
                      ...
                      <li><a href="https://taxfree.snublejuice.no">taxfree.snublejuice.no</a></li>
                  </menu>

                  <hr />

                  <p>
                      Nå er nettsiden akkurat oppdatert med denne måneds priser, med oppdaterte
                      lagerbeholdninger av de rabatterte produktene.
                  </p>
              ...
              <footer>
                  <p>
                      Dersom du ikke ønsker disse varslingene, så kan du melde deg av i profilen din på
                      <a href="https://snublejuice.no">nettsiden</a> ved å trykke på brukernavnet ditt
                      øverst.
                  </p>
              </footer>
          </body>
